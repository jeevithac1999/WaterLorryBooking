...
public class SettingsActivity extends AppCompatActivity
{
    ...
    private EditText nameEditText, phoneEditText, driverTankerName;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        driverTankerName = findViewById(R.id.driver_car_name);
        if (getType.equals("Drivers"))
        {
            driverTankerName.setVisibility(View.VISIBLE);
        }
    ...
    private void validateControllers()
    {
        ...
        else if (getType.equals("Drivers")  &&  TextUtils.isEmpty(driverTankerName.getText().toString()))
        {
            Toast.makeText(this, "Please provide your tanker Name.", Toast.LENGTH_SHORT).show();
        }
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task)
                {
                    if (task.isSuccessful())
                    {
                        ...
                        if (getType.equals("Drivers"))
                        {
                            userMap.put("car", driverTankerName.getText().toString());
                        }
